...
<nav class="bg-gradient-to-r from-orange-500 to-amber-500 shadow-lg">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="/dogs" class="text-white hover:bg-orange-600 px-3 py-2 rounded-md font-medium">Available Dogs</a>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-orange-400">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="/dogs" class="text-white block px-3 py-2 rounded-md font-medium hover:bg-orange-600">Available Dogs</a>
...
<div class="min-h-screen flex flex-col justify-center items-center px-4 text-center">
    <h1 class="text-5xl font-extrabold text-orange-600 mb-4">🐶 Adogtion</h1>
    <p class="text-xl mb-6 max-w-md">
        Welcome to Adogtion — your new best friend is just a few clicks away!
    </p>
    <a href="/dogs" class="bg-orange-500 text-white px-6 py-3 rounded-lg text-lg hover:bg-orange-600 transition">
        View Adoptable Dogs
    </a>
</div>
